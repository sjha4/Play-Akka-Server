...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """operators/""" + "$" + """operator<[^/]+>/flights/""" + "$" + """flight<[^/]+>""", """controllers.HomeController.getFlight(operator:String, flight:String)"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_HomeController_getFlight1_route = Route("GET",
  ...
  private[this] lazy val controllers_HomeController_getFlight1_invoker = createInvoker(
    HomeController_0.getFlight(fakeValue[String], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "getFlight",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_HomeController_getFlight1_route(params) =>
      call(params.fromPath[String]("operator", None), params.fromPath[String]("flight", None)) { (operator, flight) =>
        controllers_HomeController_getFlight1_invoker.call(HomeController_0.getFlight(operator, flight))
      }
